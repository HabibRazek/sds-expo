...
const NavBar = () => {
    ...
    return (
        <div className="bg-header">
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between   mx-auto p-4">
                    <Link rel="preload" href="/" className="flex items-center">
                        <Image
                            src={
                                isScrolled
                                    ? "/SDS EXPO 2023 Supply Chain & Delivery Services Exhibition.png"
                                    : "/SDS EXPO 2023 Supply Chain & Delivery Services Exhibition1.png"
                            }
                            width={300}
                            height={120}
                            className="h-8 mr-3"
                            alt="SDS EXPO 2023 Supply Chain & Delivery Services Exhibition"
                            priority={true}
                    ...
                    <div className="flex items-center md:order-2">
                        ...
                        <button
                            ...
                            type="button"
                            className={`inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-white-200 border border-red-200 ${isScrolled
                        ...
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 ">
                            <li>
                                <Link
                                    rel="preload"
                                    href="/"
                                    className={`block py-2 px-2 hover:bg-red-600 p-5 hover:text-white ${isScrolled ? "text-black" : "text-white"
                                        }`}
                                    aria-current="page"
                            ...
                            >
                                <a
                                    href="#"
                                    className={`block py-2 flex items-center px-2 p-5 hover:bg-red-600 hover:text-white ${isScrolled ? "text-black" : "text-white"
                                        }`}
                                >
                                    Exposer
                                    <svg
            ...
            {!isBurgerMenuOpen && (
                <HeaderText className="items-center justify-between" />
            )}
